...
(function(jQuery, undefined) {
	...
	var options = {
	    	...
	    	yparallax:	true,      //
	    	xorigin:		0.1,       // 0-1 - Sets default alignment. Only has effect when parallax values are something other than 1 (or true, or '100%')
	    	yorigin:		0.5,       //
	    	decay:			0.66,      // 0-1 (0 instant, 1 forever) - Sets rate of decay curve for catching up with target mouse position
	    	frameDuration:	6000,    // Int (milliseconds)
